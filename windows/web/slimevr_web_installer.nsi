...
!define MVCDLURL "http://dl.wwts.pro/files/slimevr_web_installer/5.0.0/vc_redist.x64.exe"
...
!define JREDLURL "http://dl.wwts.pro/files/slimevr_web_installer/5.0.0/OpenJDK17U-jre_x64_windows_hotspot_17.0.17_10.zip"
...
!define SVRServerDLURL "http://dl.wwts.pro/files/slimevr_web_installer/5.0.0/SlimeVR-win64.zip"
...
!define SVRDriverDLURL "http://dl.wwts.pro/files/slimevr_web_installer/5.0.0/slimevr-openvr-driver-win64.zip"
...
BrandingText "SlimeVR Installer 5.0.0"
